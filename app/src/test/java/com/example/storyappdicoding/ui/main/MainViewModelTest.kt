...
import com.example.storyappdicoding.DataDummy
import com.example.storyappdicoding.MainDispatcherRule
...
import com.example.storyappdicoding.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.stories()).thenReturn(expectedStory)
